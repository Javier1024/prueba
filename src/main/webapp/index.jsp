...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Ventas</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="compra.jsp">Comprar</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="historico.jsp">Hostorico</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="seleccion.jsp">ListaProductos</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="#"
				alt="..." />
			<!-- Masthead Heading-->
			<h2 class="masthead-heading text-uppercase mb-0">Ropa Online</h2>
			<!-- Icon Divider-->
	...
	<section class="page-section portfolio" id="portfolio">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Ofertas</h2>
			<!-- Icon Divider-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam viverra imperdiet turpis, placerat dapibus libero feugiat nec. Phasellus rhoncus eros sem, eget finibus risus aliquam at. Ut pretium justo orci, quis maximus velit blandit ac. Pellentesque odio erat, vestibulum sed pulvinar sed, rhoncus et ligula. Quisque quis interdum felis. Nullam a velit tempus eros imperdiet commodo vitae sodales nisi. Maecenas aliquam leo sit amet tincidunt mattis.</p>
				</div>
